...
type PDFService interface {
	GenerateProjectReportPDF(project *models.Project, tasks []models.Task, pic models.User, period string) (*gofpdf.Fpdf, error)
}
...
func (s *pdfService) GenerateProjectReportPDF(project *models.Project, tasks []models.Task, pic models.User, period string) (*gofpdf.Fpdf, error) {
	...
	// Main Title
	pdf.SetFont("Arial", "B", 14)
	pdf.Cell(190, 10, "LAPORAN AGENDA KERJA MINGGUAN")
	pdf.Ln(5)
	...
	colWidths := []float64{10, 25, 35, 35, 35, 20, 20, 20}
